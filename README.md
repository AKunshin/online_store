...
#### Скидки реализованы при помощи купонов-промокодов. Создать промокод можно через панель администратора. При оплате, при применении купона, скидка применяется и отображается в Stripe Checkout форме. 
#### Также Промокод можно ввести при создании Заказа из нескольких товаров

![order_disc](https://github.com/AKunshin/online_store/assets/108155374/d934f916-0da3-46ec-9097-5fb9cd7be418)
